...
make
\end{lstlisting}
% Move to XBD user guide
%Inside the platform directory , e.g. \verb|ek-tm4c123gxl_16mhz| is a file called 
%\texttt{settings.ini} which contains the platform specific settings including the memory map. 
